...
function enlargeImage(imageElement) {
    ...
    document.querySelector('.stop-button').style.zIndex = '1001';
...
function adjustStopButtonPosition(raise = true) {
    ...
    if (stopButton) {
        if (raise) {
            stopButton.style.marginTop = 'calc(var(--stop-margin-top, 5px) + 60px)';
        } else {
...
function shrinkImage() {
    ...
    document.querySelector('.stop-button').style.zIndex = '';
